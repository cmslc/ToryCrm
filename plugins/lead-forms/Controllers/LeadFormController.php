...
class LeadFormController extends Controller
{
    ...
    public function index()
    {
        ...
        return $this->view('plugin:lead-forms.index', compact('forms'));
    }
    ...
    {
        if (!$this->checkPlugin()) return;
        return $this->view('plugin:lead-forms.create');
    }
    ...
    public function edit($id)
    {
        ...
        return $this->view('plugin:lead-forms.edit', compact('form'));
    }
    ...
    public function embed($id)
    {
        ...
        $form = Database::fetch("SELECT * FROM lead_forms WHERE id = ? AND tenant_id = ?", [(int)$id, Database::tenantId()]);
        if (!$form) { $this->setFlash('error', 'Form không tồn tại.'); return $this->redirect('lead-forms'); }
        return $this->view('plugin:lead-forms.embed', compact('form'));
    }
    ...
    public function submissions($id)
    {
        ...
        return $this->view('plugin:lead-forms.submissions', compact('form', 'submissions', 'page', 'totalPages', 'total'));
    }
    ...
    public function publicForm($slug)
    {
        ...
        include BASE_PATH . '/plugins/lead-forms/views/public-form.php';
        exit;
    }
