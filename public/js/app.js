...
(function () {
	...
	function pluginData() {
		...
		if (typeof Toastify === 'undefined') { toastExamples = []; }
		...
		if (typeof Choices === 'undefined') { choicesExamples = []; }
	...
	function init() {
		try { setDefaultAttribute(); } catch(e) { console.warn('setDefaultAttribute:', e.message); }
		try { twoColumnMenuGenerate(); } catch(e) { console.warn('twoColumnMenuGenerate:', e.message); }
		try { isCustomDropdown(); } catch(e) { console.warn('isCustomDropdown:', e.message); }
		try { isCustomDropdownResponsive(); } catch(e) { console.warn('isCustomDropdownResponsive:', e.message); }
		try { initFullScreen(); } catch(e) { console.warn('initFullScreen:', e.message); }
		try { initModeSetting(); } catch(e) { console.warn('initModeSetting:', e.message); }
		try { windowLoadContent(); } catch(e) { console.warn('windowLoadContent:', e.message); }
		try { counter(); } catch(e) { console.warn('counter:', e.message); }
		try { initLeftMenuCollapse(); } catch(e) { console.warn('initLeftMenuCollapse:', e.message); }
		try { initTopbarComponents(); } catch(e) { console.warn('initTopbarComponents:', e.message); }
		try { initComponents(); } catch(e) { console.warn('initComponents:', e.message); }
		try { resetLayout(); } catch(e) { console.warn('resetLayout:', e.message); }
		try { pluginData(); } catch(e) { console.warn('pluginData:', e.message); }
		try { initLanguage(); } catch(e) { console.warn('initLanguage:', e.message); }
		try { isCollapseMenu(); } catch(e) { console.warn('isCollapseMenu:', e.message); }
		try { initMenuItemScroll(); } catch(e) { console.warn('initMenuItemScroll:', e.message); }
	}
	init();
