...
class OrderController extends Controller
{
    ...
    public function pdf($id)
    {
        ...
        if (!empty($pages)) {
            ...
            echo '<!DOCTYPE html><html lang="vi"><head><meta charset="UTF-8"><title>' . htmlspecialchars($title) . '</title>'
                ...
                . 'h2{color:#405189}.no-print{text-align:center;margin-bottom:20px}'
                . '@media print{.no-print{display:none}body{padding:20px}'
                . 'table{page-break-inside:auto}tr{page-break-inside:avoid;break-inside:avoid}'
                . 'thead{display:table-header-group}tfoot{display:table-footer-group}'
                . 'h1,h2,h3,h4{page-break-after:avoid;break-after:avoid}}</style>'
    ...
    public function export()
    {
        ...
        $columns = [
            ...
            'payment_method'   => ['label' => 'Phương thức TT'],
            'subtotal'         => ['label' => 'Tạm tính'],
            'discount_amount'  => ['label' => 'Chiết khấu'],
            'tax_amount'       => ['label' => 'Thuế'],
            'transport_amount' => ['label' => 'Phí vận chuyển'],
            'installation_amount' => ['label' => 'Phí lắp đặt'],
            'total'            => ['label' => 'Tổng tiền'],
            'paid_amount'      => ['label' => 'Đã thanh toán'],
            'currency'         => ['label' => 'Tiền tệ'],
            'vat_invoice_number' => ['label' => 'Số hóa đơn VAT'],
            'shipping_address' => ['label' => 'Địa chỉ giao hàng'],
            'shipping_contact' => ['label' => 'Liên hệ giao hàng'],
            'shipping_phone'   => ['label' => 'SĐT giao hàng'],
            'shipping_province'=> ['label' => 'Tỉnh/TP'],
            'shipping_district'=> ['label' => 'Quận/Huyện'],
            'delivery_date'    => ['label' => 'Ngày giao'],
            'delivery_partner' => ['label' => 'Đối tác giao'],
            'lading_code'      => ['label' => 'Mã vận đơn'],
            'due_date'         => ['label' => 'Hạn thanh toán'],
            'issued_date'      => ['label' => 'Ngày xuất'],
            'payment_date'     => ['label' => 'Ngày thanh toán'],
