...
class ContractController extends Controller
{
    ...
    public function export()
    {
        ...
        $columns = [
            ...
            'contract_code'       => ['label' => 'Mã HĐ'],
            'title'               => ['label' => 'Tiêu đề'],
            'type'                => ['label' => 'Loại'],
            'status'              => ['label' => 'Trạng thái'],
            'payment_method'      => ['label' => 'Phương thức TT'],
            'usage_type'          => ['label' => 'Hình thức'],
            'contact_name'        => ['label' => 'Khách hàng (bên B)'],
            ...
            'vat_percent'         => ['label' => 'VAT %'],
            'value'               => ['label' => 'Giá trị HĐ'],
            'actual_value'        => ['label' => 'Giá trị thực tế'],
            'executed_amount'     => ['label' => 'Đã thực hiện'],
            'paid_amount'         => ['label' => 'Đã thanh toán'],
            'start_date'          => ['label' => 'Ngày bắt đầu'],
            'end_date'            => ['label' => 'Ngày kết thúc'],
            'signed_date'         => ['label' => 'Ngày ký'],
            'actual_start_date'   => ['label' => 'Bắt đầu thực tế'],
            'actual_end_date'     => ['label' => 'Kết thúc thực tế'],
            'installation_address'=> ['label' => 'Địa chỉ lắp đặt'],
            'location'            => ['label' => 'Địa điểm'],
            'project'             => ['label' => 'Dự án'],
            'party_a_name'        => ['label' => 'Bên A'],
            'party_a_representative' => ['label' => 'Người đại diện A'],
            'party_a_tax_code'    => ['label' => 'MST bên A'],
            'party_b_representative' => ['label' => 'Người đại diện B'],
            'owner_name'          => ['label' => 'Phụ trách'],
            'auto_renew'          => ['label' => 'Tự gia hạn'],
