    ...
    cursor: pointer;
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="wfName" placeholder="Nhập tên workflow">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Mô tả</label>
                        <input type="text" class="form-control" id="wfDescription" placeholder="Mô tả ngắn">
                    </div>
                </div>
            </div>
        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('btnSaveWorkflow').addEventListener('click', function() {
                ...
                form.method = 'POST';
                form.action = '<?= url("workflows/store") ?>';
