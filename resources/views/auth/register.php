    ...
    <div class="auth-card">
        ...
        <div class="card shadow-lg border-0">
            <div class="card-body p-4">
                <div class="text-center mb-4">
                    <h5 class="text-primary" style="color: #405189 !important;">Tạo tài khoản mới</h5>
                    <p class="text-muted">Đăng ký để bắt đầu sử dụng ToryCRM.</p>
                </div>
                ...
                <form action="<?= url('register') ?>" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name"
                               value="<?= e(old('name')) ?>" placeholder="Nhập họ tên" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="tel" class="form-control" id="phone" name="phone"
                               value="<?= e(old('phone')) ?>" placeholder="Nhập số điện thoại">
                    </div>
        ...
        <div class="text-center mt-3">
            <p class="text-white mb-0">
                Đã có tài khoản?
                <a href="<?= url('login') ?>" class="fw-semibold text-white text-decoration-underline">Đăng nhập</a>
            </p>
        </div>
    </div>
