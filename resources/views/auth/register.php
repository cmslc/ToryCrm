                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="card mt-4 card-bg-fill">
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Đăng ký miễn phí để bắt đầu sử dụng ToryCRM.</p>
                                </div>
                                ...
                                <div class="p-2 mt-4">
                                    <form action="<?= url('register') ?>" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name" value="<?= e(old('name')) ?>" placeholder="Nhập họ tên" required>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup">
                                                <input type="password" class="form-control pe-5 password-input" id="password_confirmation" name="password_confirmation" placeholder="Nhập lại mật khẩu" required>
                                                <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon" type="button" onclick="togglePassword('password_confirmation', this)">
                                                    <i class="ri-eye-off-fill align-middle"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="terms">Tôi đồng ý với <a href="<?= url('terms') ?>" class="text-primary" target="_blank">Điều khoản sử dụng</a></label>
                                        </div>
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Đã có tài khoản? <a href="<?= url('login') ?>" class="fw-semibold text-primary text-decoration-underline">Đăng nhập</a></p>
                        </div>
                    </div>
                </div>
            </div>
