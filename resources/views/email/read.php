        ...
        <div class="bg-white border-top px-4 py-3">
            ...
            <div class="d-flex gap-2 flex-wrap">
                ...
                <div class="border rounded px-3 py-2 d-flex align-items-center gap-2">
                    ...
                    <a href="<?= url('email/download?file_url=' . urlencode($attUrl) . '&file_name=' . urlencode($att['filename'])) ?>" class="btn btn-soft-primary btn-icon" title="Tải xuống"><i class="ri-download-2-line"></i></a>
                </div>
                <?php endforeach; ?>
            </div>
        </div>
