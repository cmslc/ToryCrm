<?php $pageTitle = 'Tạo đơn hàng mua'; ?>
                                ...
                                <table class="table align-middle mb-0">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td><input type="number" class="form-control" name="discount_amount" value="0" min="0" onchange="calcTotal()"></td>
                                            <td></td>
                                        </tr>
                                        <tr>
        ...
        function addItem() {
            ...
            tr.innerHTML = `
                ...
                <td><input type="number" class="form-control" name="items[${i}][quantity]" value="1" min="0.01" step="0.01" onchange="calcRow(${i})"></td>
                <td><input type="text" class="form-control" name="items[${i}][unit]" id="pu-${i}" value="Cái"></td>
                <td><input type="number" class="form-control" name="items[${i}][unit_price]" id="pp-${i}" value="0" min="0" onchange="calcRow(${i})"></td>
                <td><input type="number" class="form-control" name="items[${i}][tax_rate]" id="pt-${i}" value="0" min="0" max="100" step="0.01" onchange="calcRow(${i})"></td>
