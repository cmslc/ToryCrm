...
?>
        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
            ...
            <div class="d-flex gap-2">
                ...
                <button type="button" class="btn btn-soft-info" data-bs-toggle="modal" data-bs-target="#exportProductsModal"><i class="ri-download-line me-1"></i> Export</button>
            ...
            <div class="card-header p-2">
                <form method="GET" action="<?= url('products') ?>" class="d-flex align-items-center gap-2 flex-wrap">
                    ...
                    <?php if (!empty(array_filter($filters ?? []))): ?>
                        <a href="<?= url('products') ?>" class="btn btn-soft-danger btn-icon" title="Xóa lọc"><i class="ri-refresh-line"></i></a>
                    <?php endif; ?>
                ...
                <?php if (($products['total_pages'] ?? 0) > 1): ?>
                    <div class="d-flex justify-content-between align-items-center px-3 py-3 border-top">
                        <div class="d-flex align-items-center gap-2">
                            <span class="text-muted fs-13">Hiển thị <strong><?= (($products['page'] - 1) * ($filters['per_page'] ?? 20)) + 1 ?> - <?= min($products['page'] * ($filters['per_page'] ?? 20), $products['total']) ?></strong> / <strong><?= number_format($products['total']) ?></strong></span>
