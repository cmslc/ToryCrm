            ...
            <div class="card-header p-2">
                <form method="GET" action="<?= url('orders') ?>" class="d-flex align-items-center gap-2 flex-wrap">
                    ...
                    <?php if (!empty(array_filter($filters ?? []))): ?>
                        <a href="<?= url('orders') ?>" class="btn btn-soft-danger btn-icon" title="Xóa lọc"><i class="ri-refresh-line"></i></a>
                    <?php endif; ?>
...
$exportColumns = [
    ...
    'currency' => 'Tiền tệ',
    'vat_invoice_number' => 'Số hóa đơn VAT',
    'shipping_address' => 'Địa chỉ giao hàng',
    'shipping_contact' => 'Liên hệ giao hàng',
    'shipping_phone' => 'SĐT giao hàng',
    'shipping_province' => 'Tỉnh/TP',
    'shipping_district' => 'Quận/Huyện',
    'delivery_date' => 'Ngày giao',
    'delivery_partner' => 'Đối tác giao',
    'lading_code' => 'Mã vận đơn',
    'due_date' => 'Hạn thanh toán',
    'issued_date' => 'Ngày xuất',
